...
int Settings::getIntFromSettings(std::vector<std::string>& inputFile,
...
std::string Settings::getStringFromSettings(std::vector<std::string>& inputFile,
											const std::string& inputString)
{
	for (int i = 0; i < inputFile.size(); i++)
	{
...
bool Settings::getBoolFromSettings(std::vector<std::string>& inputFile,
								   const std::string& inputString)
{
	for (int i = 0; i < inputFile.size(); i++)
	{
