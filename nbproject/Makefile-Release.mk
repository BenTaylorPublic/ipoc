...
${OBJECTDIR}/Conversions.o: Conversions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Conversions.o Conversions.cpp
...
${OBJECTDIR}/IPOCFont.o: IPOCFont.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPOCFont.o IPOCFont.cpp
...
${OBJECTDIR}/IPOCSettings.o: IPOCSettings.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPOCSettings.o IPOCSettings.cpp

${OBJECTDIR}/IPOCSprite.o: IPOCSprite.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPOCSprite.o IPOCSprite.cpp

${OBJECTDIR}/IPOCText.o: IPOCText.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPOCText.o IPOCText.cpp

${OBJECTDIR}/IPOCTexture.o: IPOCTexture.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPOCTexture.o IPOCTexture.cpp

${OBJECTDIR}/IPOCWindow.o: IPOCWindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IPOCWindow.o IPOCWindow.cpp

${OBJECTDIR}/InputController.o: InputController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputController.o InputController.cpp

${OBJECTDIR}/MasterController.o: MasterController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MasterController.o MasterController.cpp

${OBJECTDIR}/OnscreenButton.o: OnscreenButton.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OnscreenButton.o OnscreenButton.cpp

${OBJECTDIR}/OnscreenButtonManager.o: OnscreenButtonManager.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OnscreenButtonManager.o OnscreenButtonManager.cpp

${OBJECTDIR}/OutputController.o: OutputController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutputController.o OutputController.cpp

${OBJECTDIR}/Point2D.o: Point2D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Point2D.o Point2D.cpp

${OBJECTDIR}/ProcessController.o: ProcessController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcessController.o ProcessController.cpp
